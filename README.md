...
- **Two eye styles** — switch between the original mood engine and NOVA's independent eight-expression autoplay; your choice is remembered.
- **Palette gradients** — NOVA turns every selected theme color into a luminous light-to-dark eye gradient.
